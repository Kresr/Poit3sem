#include "stdafx.h" // Подключение стандартных заголовочных файлов
#include "Log.h" // Подключение заголовочного файла для логирования
...
namespace Log // Пространство имен Log
{
	...
	void WriteIn(LOG log, In::IN in)
	{
		(*log.stream) << "--— Параметры —— \n" // Заголовок раздела с параметрами
			...
			<< "Удалено пробелов: " << in.removedSpaces << "\n"; // Добавляем строку для вывода количества удаленных пробелов
	}
